...
<body>
    ...
    <div class="widget">
        ...
        <div style="display: grid;grid-template-columns: 1fr 1fr;margin-top:50px">
            <label>座席<input type="text" name="tableno" class="output" required readonly onclick="focusCheck()" <?php
                if ($p == 2) {
                ...
                ?>></label>
            <label>人数<input type="text" class="quantity" name="visitors" id="visitors" required readonly
                    onclick="focusCheck()" <?php 
                if ($p == 2) {
